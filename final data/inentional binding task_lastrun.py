...
expName = 'inentional binding task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\91982\\Downloads\\Psychopy\\experiment 8\\inentional binding task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay betweeen the key press and the beep sound (0-999). Click submit after entering the value',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=34.0, method='random', 
        ...
        trialList=data.importConditions('experiment 8.xlsx'),
